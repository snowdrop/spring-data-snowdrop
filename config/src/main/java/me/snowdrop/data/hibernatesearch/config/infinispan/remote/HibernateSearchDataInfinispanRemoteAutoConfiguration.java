...
public class HibernateSearchDataInfinispanRemoteAutoConfiguration {

    private InfinispanRemoteProperties properties;

    public HibernateSearchDataInfinispanRemoteAutoConfiguration(InfinispanRemoteProperties properties) {
