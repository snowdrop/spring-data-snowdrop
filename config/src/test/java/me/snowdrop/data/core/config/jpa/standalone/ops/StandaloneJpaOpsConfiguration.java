 ...
 */
package me.snowdrop.data.core.config.jpa.standalone.ops;
...
import me.snowdrop.data.core.config.jpa.standalone.ops.repository.sd.StandaloneJpaSnowdropOpsRepository;
import me.snowdrop.data.core.config.jpa.standalone.ops.repository.jpa.StandaloneJpaOpsRepository;
...
@EnableSnowdropRepositories(basePackageClasses = StandaloneJpaSnowdropOpsRepository.class)
public class StandaloneJpaOpsConfiguration {

  @Bean
  public TestedRepository<Ops> testedRepository(StandaloneJpaSnowdropOpsRepository repository) {
