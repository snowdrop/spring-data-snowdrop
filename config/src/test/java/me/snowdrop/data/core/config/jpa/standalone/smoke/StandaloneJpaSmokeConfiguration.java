 ...
 */
package me.snowdrop.data.core.config.jpa.standalone.smoke;
...
import me.snowdrop.data.core.config.jpa.standalone.smoke.repository.sd.StandaloneJpaSnowdropFruitRepository;
import me.snowdrop.data.core.config.jpa.standalone.smoke.repository.jpa.StandaloneJpaFruitRepository;
...
@EnableSnowdropRepositories(basePackageClasses = StandaloneJpaSnowdropFruitRepository.class)
