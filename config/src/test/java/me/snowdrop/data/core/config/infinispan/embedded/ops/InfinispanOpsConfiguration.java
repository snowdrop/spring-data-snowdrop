 ...
 */
package me.snowdrop.data.core.config.infinispan.embedded.ops;

import me.snowdrop.data.core.TestedRepository;
import me.snowdrop.data.core.config.infinispan.embedded.InfinispanConfiguration;
import me.snowdrop.data.core.config.infinispan.embedded.ops.repository.StandaloneInfinispanSnowdropOpsRepository;
...
@EnableSnowdropRepositories(basePackageClasses = StandaloneInfinispanSnowdropOpsRepository.class)
public class InfinispanOpsConfiguration {

  @Bean
  public TestedRepository<Ops> testedRepository(StandaloneInfinispanSnowdropOpsRepository repository) {
