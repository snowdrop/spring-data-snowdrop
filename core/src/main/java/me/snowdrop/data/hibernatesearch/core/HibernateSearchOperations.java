...
public interface HibernateSearchOperations {
     ...
     */
    <S extends T, T, ID> S save(HibernateSearchEntityInformation<T, ID> ei, S entity);
     ...
     */
    <S extends T, T, ID> Iterable<S> saveAll(HibernateSearchEntityInformation<T, ID> ei, Iterable<S> entities);
     ...
     */
    <T, ID> Optional<T> findById(HibernateSearchEntityInformation<T, ID> ei, ID id);
     ...
     * @throws IllegalArgumentException if {@code id} is {@literal null}.
     */
    <T, ID> boolean existsById(HibernateSearchEntityInformation<T, ID> ei, ID id);
     ...
     */
    <T, ID> Iterable<T> findAllById(HibernateSearchEntityInformation<T, ID> ei, Iterable<ID> ids);
     ...
     */
    <T, ID> void deleteById(HibernateSearchEntityInformation<T, ID> ei, ID id);
     ...
     * @throws IllegalArgumentException in case the given entity is {@literal null}.
     */
    <S extends T, T, ID> void delete(HibernateSearchEntityInformation<T, ID> ei, S entity);
     ...
     */
    <S extends T, T, ID> void deleteAll(HibernateSearchEntityInformation<T, ID> ei, Iterable<S> entities);

    /**
     * Deletes all entities managed by the repository.
     */
    <T, ID> void deleteAll(HibernateSearchEntityInformation<T, ID> ei);
}
