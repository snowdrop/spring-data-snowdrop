 ...
 */
public class GaeSearchTest extends SearchTestBase {

    @Deployment
    public static Archive<?> getDeployment() {
        WebArchive war = getBaseDeployment();
        war.addPackage(GaeDatasourceMapper.class.getPackage());
        war.addClasses(GaeSearchConfiguration.class);
    ...
    protected Class<?> getConfigurationClass() {
        return GaeSearchConfiguration.class;
    }
}
